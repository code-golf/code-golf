...
new Chart(canvases[0].getContext('2d'), {
    ...
    data: {
        ...
        datasets: [{
            data: JSON.parse(document.querySelector('#holesByDifficulty').innerText),
...
let data = JSON.parse(document.querySelector('#solutionsByLang').innerText);
...
new Chart(canvases[2].getContext('2d'), {
    ...
    data: {
        datasets: [{
            data: JSON.parse(document.querySelector('#distributionOfHoles').innerText),
            borderColor: '#3498DB',
...
new Chart(canvases[3].getContext('2d'), {
    ...
    data: {
        datasets: [{
            data: JSON.parse(document.querySelector('#distributionOfLangs').innerText),
            borderColor: '#3498DB',
            backgroundColor: 'rgb(52, 152, 219, .5)',
            pointBorderColor: '#3498DB',
            pointBackgroundColor: '#3498DB',
