...
COPY --from=codegolf/lang-csharp     /     /langs/csharp/rootfs/
COPY --from=codegolf/lang-fortran    /    /langs/fortran/rootfs/
COPY --from=codegolf/lang-fsharp     /     /langs/fsharp/rootfs/
...
COPY --from=0 /empty     /langs/csharp/rootfs/proc/
COPY --from=0 /empty     /langs/csharp/rootfs/tmp/
COPY --from=0 /empty    /langs/fortran/rootfs/proc/
COPY --from=0 /empty    /langs/fortran/rootfs/tmp/
COPY --from=0 /empty     /langs/fsharp/rootfs/proc/
COPY --from=0 /empty     /langs/fsharp/rootfs/tmp/
