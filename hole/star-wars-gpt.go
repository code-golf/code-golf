...
var _ = answerFunc("star-wars-gpt", func() []Answer {
	...
	for i := 0; i < 10; i += 2 {
		...
		answers[i/2] = Answer{Args: args, Answer: outputSWGPT.String()}
	}
	...
	staticResult5 := "order\nhis\nseveral\nluke\nbrave\nand\nthe\nof\nabsence\nknights\non\nsenate"
	answers[5] = Answer{Args: []string{staticTest1}, Answer: staticResult1}
	answers[6] = Answer{Args: []string{staticTest2}, Answer: staticResult2}
	answers[7] = Answer{Args: []string{staticTest3}, Answer: staticResult3}
	answers[8] = Answer{Args: []string{staticTest4}, Answer: staticResult4}
	answers[9] = Answer{Args: []string{staticTest5}, Answer: staticResult5}
