...
var repeatingDecimalFractions = []struct{ p, q int }{
	{0, 1}, {0, 7}, {0, 32}, {1, 1}, {1, 2}, {1, 3}, {1, 4}, {1, 5}, {1, 7}, {1, 10},
	{1, 22}, {1, 25}, {1, 28}, {1, 35}, {1, 40}, {1, 50}, {1, 64}, {1, 70}, {1, 96}, {1, 97},
	{2, 7}, {2, 14}, {2, 52}, {3, 94}, {4, 2}, {4, 94}, {5, 13}, {5, 65}, {5, 75}, {5, 94},
	{10, 7}, {17, 10}, {20, 7}, {40, 2}, {83, 60}, {97, 6}, {97, 7}, {98, 49}, {99, 1}, {99, 3},
}
