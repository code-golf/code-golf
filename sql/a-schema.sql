...
CREATE TYPE hole AS ENUM (
    ...
    'ln-2', 'look-and-say', 'lucky-numbers', 'lucky-tickets',
    'lyndon-factorization', 'mahjong', 'mandelbrot', 'maze', 'medal-tally',
    'minesweeper', 'morse-decoder', 'morse-encoder', 'multitap-input',
    'musical-chords', 'n-queens', 'nfa-simulator', 'nim', 'niven-numbers',
    ...
    'rectangle-fill', 'repeating-decimals', 'reverse-polish-notation',
    'reversi', 'rijndael-s-box', 'rock-paper-scissors-spock-lizard',
    'roman-to-arabic', 'rot13', 'rule-110', 'scrambled-sort',
