...
CREATE TYPE hole AS ENUM (
    ...
    'chess-move-validation', 'christmas-trees', 'collatz', 'connect-four',
    ...
    'langtons-ant', 'leap-years', 'levenshtein-distance', 'leyland-numbers',
    'ln-2', 'look-and-say', 'lucky-numbers', 'lucky-tickets', 'mahjong',
    'mandelbrot', 'maze', 'medal-tally', 'minesweeper', 'morse-decoder',
    'morse-encoder', 'multitap-input', 'musical-chords', 'n-queens',
    'nfa-simulator', 'nim', 'niven-numbers', 'niven-numbers-long',
    'number-spiral', 'numbrix', 'odd-polyomino-tiling', 'odious-numbers',
