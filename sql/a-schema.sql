...
CREATE TYPE hole AS ENUM (
    ...
    'kolakoski-constant', 'kolakoski-sequence', 'langtons-ant',
    'leap-years', 'levenshtein-distance', 'leyland-numbers', 'ln-2',
    'look-and-say', 'lucky-numbers', 'lucky-tickets', 'mahjong',
    ...
    'numbrix', 'odd-polyomino-tiling', 'odious-numbers', 'odious-numbers-long',
