...
CREATE TYPE cheevo AS ENUM (
    ...
    'forty-winks', 'go-forth', 'going-postal', 'gone-in-60-holes',
    'happy-birthday-code-golf', 'happy-go-lucky', 'hello-world',
    'hextreme-agony', 'horse-of-a-different-color', 'how-about-second-pi',
    'hugs-and-kisses', 'inception', 'independence-day', 'interview-ready',
    'into-space', 'its-over-9000', 'jeweler', 'just-kidding',
    'like-comment-subscribe', 'marathon-runner', 'mary-had-a-little-lambda',
    'may-the-4ᵗʰ-be-with-you', 'my-god-its-full-of-stars',
    'neunundneunzig-luftballons', 'never-eat-shredded-wheat', 'off-the-grid',
...
CREATE TYPE lang AS ENUM (
    ...
    'iogii', 'j', 'janet', 'java', 'javascript', 'jq', 'julia', 'k',
    'kamilalisp', 'knight', 'kotlin', 'lua', 'luau', 'nim', 'ocaml', 'odin',
    'pascal', 'perl', 'php', 'picat', 'powershell', 'prolog', 'python', 'qore',
    'r', 'racket', 'raku', 'rebol', 'rexx', 'rockstar', 'ruby', 'rust',
    'scala', 'scheme', 'sed', 'sql', 'squirrel', 'stax', 'swift', 'tcl', 'tex',
    'uiua', 'umka', 'v', 'vala', 'viml', 'vyxal', 'wren', 'zig'
);
