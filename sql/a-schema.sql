...
CREATE TYPE hole AS ENUM (
    ...
    'divisors', 'dragon-curve', 'ellipse-perimeters', 'emirp-numbers',
    ...
    'highly-composite-numbers', 'hilbert-curve', 'huffman-encoder',
    'intersection', 'inventory-sequence', 'isbn', 'jacobi-symbol',
    'kaprekar-numbers', 'kolakoski-constant', 'kolakoski-sequence',
    'leap-years', 'levenshtein-distance', 'leyland-numbers', 'ln-2',
    'look-and-say', 'lucky-numbers', 'lucky-tickets', 'mahjong', 'mandelbrot',
    'maze', 'medal-tally', 'minesweeper', 'morse-decoder', 'morse-encoder',
    'multitap-input', 'musical-chords', 'n-queens', 'nfa-simulator', 'nim',
...
CREATE TYPE lang AS ENUM (
    ...
    'k', 'knight', 'kotlin', 'lily', 'lua', 'luau', 'nim', 'nushell', 'ocaml',
    'odin', 'pascal', 'perl', 'php', 'picat', 'powershell', 'prolog',
    'python', 'qore', 'r', 'racket', 'raku', 'rebol', 'rexx', 'rockstar',
    'ruby', 'rust', 'scala', 'scheme', 'sed', 'sql', 'squirrel', 'stax',
    'swift', 'tcl', 'tex', 'uiua', 'umka', 'v', 'vala', 'viml', 'vyxal',
    'wren', 'zig'
);
