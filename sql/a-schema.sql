...
CREATE TYPE cheevo AS ENUM (
    ...
    'polyglutton', 'real-programmers', 'right-on', 'ring-toss', 'rm-rf',
    ...
    'twelvetide', 'twenty-kiloleagues', 'typesetter', 'under-pressure',
    'up-to-eleven', 'vampire-byte', 'watt-are-you-doing', 'when-in-rome',
