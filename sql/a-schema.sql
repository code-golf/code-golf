...
CREATE TYPE cheevo AS ENUM (
    ...
    'double-slit-experiment', 'down-to-the-metal', 'elephpant-in-the-room',
    'emergency-room', 'evil-scheme', 'fish-n-chips', 'five',
    'flag-those-mines', 'fore', 'forty-winks', 'full-stack-dev', 'go-forth',
