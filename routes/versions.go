...
const versionTable = "" +
	...
	"<tr><th class=julia>Julia<td>1.3.1<td class=wide><a href=//julialang.org>website</a>" +
	...
	"<tr><th class=swift>Swift<td>5.1.5<td class=wide><a href=//swift.org>website</a>"
