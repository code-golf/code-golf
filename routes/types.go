...
┗━━━┷━━━┷━━━┻━━━┷━━━┷━━━┻━━━┷━━━┷━━━┛</pre>`,
		...
		"", "",
		"united-states", "United States", "Transform", "", "",
		"Given each US state (and a federal district) print the corresponding US Postal Service abbreviation.<p>The full mapping is as follows:<div id=states><table><thead><tr><th>State<th>Abbr.<tbody><tr><td>Alabama<td>AL<tr><td>Alaska<td>AK<tr><td>Arizona<td>AZ<tr><td>Arkansas<td>AR<tr><td>California<td>CA<tr><td>Colorado<td>CO<tr><td>Connecticut<td>CT<tr><td>Delaware<td>DE<tr><td>District of Columbia<td>DC<tr><td>Florida<td>FL<tr><td>Georgia<td>GA<tr><td>Hawaii<td>HI<tr><td>Idaho<td>ID</table><table><thead><tr><th>State<th>Abbr.<tbody><tr><td>Illinois<td>IL<tr><td>Indiana<td>IN<tr><td>Iowa<td>IA<tr><td>Kansas<td>KS<tr><td>Kentucky<td>KY<tr><td>Louisiana<td>LA<tr><td>Maine<td>ME<tr><td>Maryland<td>MD<tr><td>Massachusetts<td>MA<tr><td>Michigan<td>MI<tr><td>Minnesota<td>MN<tr><td>Mississippi<td>MS<tr><td>Missouri<td>MO</table><table><thead><tr><th>State<th>Abbr.<tbody><tr><td>Montana<td>MT<tr><td>Nebraska<td>NE<tr><td>Nevada<td>NV<tr><td>New Hampshire<td>NH<tr><td>New Jersey<td>NJ<tr><td>New Mexico<td>NM<tr><td>New York<td>NY<tr><td>North Carolina<td>NC<tr><td>North Dakota<td>ND<tr><td>Ohio<td>OH<tr><td>Oklahoma<td>OK<tr><td>Oregon<td>OR<tr><td>Pennsylvania<td>PA</table><table><thead><tr><th>State<th>Abbr.<tbody><tr><td>Rhode Island<td>RI<tr><td>South Carolina<td>SC<tr><td>South Dakota<td>SD<tr><td>Tennessee<td>TN<tr><td>Texas<td>TX<tr><td>Utah<td>UT<tr><td>Vermont<td>VT<tr><td>Virginia<td>VA<tr><td>Washington<td>WA<tr><td>West Virginia<td>WV<tr><td>Wisconsin<td>WI<tr><td>Wyoming<td>WY</table></div>",
	}, {
		"", "",
		"λ", "λ", "Mathematics", "", "",
