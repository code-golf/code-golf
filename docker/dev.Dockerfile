...
COPY --from=codegolf/lang-gleam        ["/", "/langs/gleam/rootfs/"       ] # 99.2 MiB
COPY --from=codegolf/lang-d            ["/", "/langs/d/rootfs/"           ] # 93.3 MiB
COPY --from=codegolf/lang-coconut      ["/", "/langs/coconut/rootfs/"     ] # 84.9 MiB
...
COPY --from=codegolf/lang-scala        ["/", "/langs/scala/rootfs/"       ] # 75.1 MiB
COPY --from=codegolf/lang-vyxal        ["/", "/langs/vyxal/rootfs/"       ] # 69.2 MiB
COPY --from=codegolf/lang-clojure      ["/", "/langs/clojure/rootfs/"     ] # 66.7 MiB
COPY --from=codegolf/lang-groovy       ["/", "/langs/groovy/rootfs/"      ] # 63.4 MiB
...
COPY --from=codegolf/lang-cjam         ["/", "/langs/cjam/rootfs/"        ] # 48.9 MiB
COPY --from=codegolf/lang-java         ["/", "/langs/java/rootfs/"        ] # 43.5 MiB
COPY --from=codegolf/lang-javascript   ["/", "/langs/javascript/rootfs/"  ] # 43.5 MiB
COPY --from=codegolf/lang-hy           ["/", "/langs/hy/rootfs/"          ] # 41.9 MiB
...
COPY --from=codegolf/lang-r            ["/", "/langs/r/rootfs/"           ] # 30.6 MiB
