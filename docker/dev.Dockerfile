...
COPY --from=codegolf/lang-haskell    ["/", "/langs/haskell/rootfs/"   ] #  350 MiB
...
COPY --from=codegolf/lang-rockstar   ["/", "/langs/rockstar/rootfs/"  ] #  167 MiB
...
COPY --from=codegolf/lang-assembly   ["/", "/langs/assembly/rootfs/"  ] # 94.7 MiB
...
COPY --from=codegolf/lang-v          ["/", "/langs/v/rootfs/"         ] # 59.8 MiB
...
COPY --from=codegolf/lang-ruby       ["/", "/langs/ruby/rootfs/"      ] # 27.9 MiB
...
COPY --from=codegolf/lang-sql        ["/", "/langs/sql/rootfs/"       ] # 1.19 MiB
