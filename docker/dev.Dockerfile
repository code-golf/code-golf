...
COPY --from=codegolf/lang-rust       ["/", "/langs/rust/rootfs/"      ] #  329 MiB
...
COPY --from=codegolf/lang-assembly   ["/", "/langs/assembly/rootfs/"  ] #  104 MiB
...
COPY --from=codegolf/lang-hexagony   ["/", "/langs/hexagony/rootfs/"  ] # 8.80 MiB
