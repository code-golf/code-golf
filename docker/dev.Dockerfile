...
COPY --from=codegolf/lang-rust         ["/", "/langs/rust/rootfs/"        ] #  333 MiB
...
COPY --from=codegolf/lang-cpp          ["/", "/langs/cpp/rootfs/"         ] #  141 MiB
...
COPY --from=codegolf/lang-rockstar-2   ["/", "/langs/rockstar-2/rootfs/"  ] # 4.20 MiB
