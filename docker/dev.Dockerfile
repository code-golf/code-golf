...
COPY --from=codegolf/lang-kotlin       ["/", "/langs/kotlin/rootfs/"      ] #  136 MiB
...
COPY --from=codegolf/lang-fortran      ["/", "/langs/fortran/rootfs/"     ] #  102 MiB
...
COPY --from=codegolf/lang-gleam        ["/", "/langs/gleam/rootfs/"       ] # 76.3 MiB
COPY --from=codegolf/lang-raku         ["/", "/langs/raku/rootfs/"        ] # 75.6 MiB
COPY --from=codegolf/lang-scala        ["/", "/langs/scala/rootfs/"       ] # 75.2 MiB
COPY --from=codegolf/lang-vyxal        ["/", "/langs/vyxal/rootfs/"       ] # 69.3 MiB
COPY --from=codegolf/lang-clojure      ["/", "/langs/clojure/rootfs/"     ] # 67.3 MiB
COPY --from=codegolf/lang-groovy       ["/", "/langs/groovy/rootfs/"      ] # 63.5 MiB
COPY --from=codegolf/lang-elixir       ["/", "/langs/elixir/rootfs/"      ] # 58.7 MiB
COPY --from=codegolf/lang-erlang       ["/", "/langs/erlang/rootfs/"      ] # 51.8 MiB
...
COPY --from=codegolf/lang-cjam         ["/", "/langs/cjam/rootfs/"        ] # 49.0 MiB
COPY --from=codegolf/lang-java         ["/", "/langs/java/rootfs/"        ] # 43.6 MiB
...
COPY --from=codegolf/lang-uiua         ["/", "/langs/uiua/rootfs/"        ] # 19.4 MiB
