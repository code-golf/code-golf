...
COPY --from=codegolf/lang-kotlin       ["/", "/langs/kotlin/rootfs/"      ] #  223 MiB
...
COPY --from=codegolf/lang-scheme       ["/", "/langs/scheme/rootfs/"      ] # 8.96 MiB
