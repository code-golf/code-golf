...
COPY --from=codegolf/lang-kotlin       ["/", "/langs/kotlin/rootfs/"      ] #  217 MiB
...
COPY --from=codegolf/lang-coconut      ["/", "/langs/coconut/rootfs/"     ] # 84.7 MiB
COPY --from=codegolf/lang-ocaml        ["/", "/langs/ocaml/rootfs/"       ] # 84.4 MiB
