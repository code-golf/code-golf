...
COPY --from=codegolf/lang-rust       ["/", "/langs/rust/rootfs/"      ] #  720 MiB
...
COPY --from=codegolf/lang-assembly   ["/", "/langs/assembly/rootfs/"  ] # 73.2 MiB
...
COPY --from=codegolf/lang-javascript ["/", "/langs/javascript/rootfs/"] # 23.4 MiB
