...
COPY --from=codegolf/lang-rust         ["/", "/langs/rust/rootfs/"        ] #  341 MiB
...
COPY --from=codegolf/lang-odin         ["/", "/langs/odin/rootfs/"        ] #  256 MiB
COPY --from=codegolf/lang-dart         ["/", "/langs/dart/rootfs/"        ] #  236 MiB
...
COPY --from=codegolf/lang-gleam        ["/", "/langs/gleam/rootfs/"       ] # 87.9 MiB
COPY --from=codegolf/lang-coconut      ["/", "/langs/coconut/rootfs/"     ] # 85.7 MiB
COPY --from=codegolf/lang-raku         ["/", "/langs/raku/rootfs/"        ] # 75.8 MiB
COPY --from=codegolf/lang-civet        ["/", "/langs/civet/rootfs/"       ] # 67.9 MiB
COPY --from=codegolf/lang-coffeescript ["/", "/langs/coffeescript/rootfs/"] # 67.5 MiB
COPY --from=codegolf/lang-clojure      ["/", "/langs/clojure/rootfs/"     ] # 66.3 MiB
COPY --from=codegolf/lang-java         ["/", "/langs/java/rootfs/"        ] # 58.4 MiB
COPY --from=codegolf/lang-egel         ["/", "/langs/egel/rootfs/"        ] # 50.3 MiB
COPY --from=codegolf/lang-v            ["/", "/langs/v/rootfs/"           ] # 49.9 MiB
...
COPY --from=codegolf/lang-hy           ["/", "/langs/hy/rootfs/"          ] # 41.5 MiB
...
COPY --from=codegolf/lang-05ab1e       ["/", "/langs/05ab1e/rootfs/"      ] # 29.5 MiB
COPY --from=codegolf/lang-python       ["/", "/langs/python/rootfs/"      ] # 29.0 MiB
...
COPY --from=codegolf/lang-viml         ["/", "/langs/viml/rootfs/"        ] # 24.0 MiB
...
COPY --from=codegolf/lang-hare         ["/", "/langs/hare/rootfs/"        ] # 11.1 MiB
COPY --from=codegolf/lang-hexagony     ["/", "/langs/hexagony/rootfs/"    ] # 8.78 MiB
COPY --from=codegolf/lang-php          ["/", "/langs/php/rootfs/"         ] # 8.40 MiB
COPY --from=codegolf/lang-tex          ["/", "/langs/tex/rootfs/"         ] # 8.21 MiB
COPY --from=codegolf/lang-scheme       ["/", "/langs/scheme/rootfs/"      ] # 7.36 MiB
...
COPY --from=codegolf/lang-fish         ["/", "/langs/fish/rootfs/"        ] # 4.80 MiB
COPY --from=codegolf/lang-algol-68     ["/", "/langs/algol-68/rootfs/"    ] # 4.66 MiB
COPY --from=codegolf/lang-cobol        ["/", "/langs/cobol/rootfs/"       ] # 4.56 MiB
COPY --from=codegolf/lang-rockstar-2   ["/", "/langs/rockstar-2/rootfs/"  ] # 4.44 MiB
COPY --from=codegolf/lang-squirrel     ["/", "/langs/squirrel/rootfs/"    ] # 3.96 MiB
COPY --from=codegolf/lang-hush         ["/", "/langs/hush/rootfs/"        ] # 3.27 MiB
COPY --from=codegolf/lang-rexx         ["/", "/langs/rexx/rootfs/"        ] # 3.04 MiB
COPY --from=codegolf/lang-forth        ["/", "/langs/forth/rootfs/"       ] # 2.86 MiB
COPY --from=codegolf/lang-awk          ["/", "/langs/awk/rootfs/"         ] # 1.78 MiB
...
COPY --from=codegolf/lang-befunge      ["/", "/langs/befunge/rootfs/"     ] # 1.18 MiB
COPY --from=codegolf/lang-berry        ["/", "/langs/berry/rootfs/"       ] #  973 KiB
COPY --from=codegolf/lang-jq           ["/", "/langs/jq/rootfs/"          ] #  964 KiB
