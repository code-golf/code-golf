...
COPY --from=codegolf/lang-assembly     ["/", "/langs/assembly/rootfs/"    ] #  116 MiB
...
COPY --from=codegolf/lang-uiua         ["/", "/langs/uiua/rootfs/"        ] # 30.3 MiB
...
COPY --from=codegolf/lang-arturo       ["/", "/langs/arturo/rootfs/"      ] # 5.33 MiB
...
COPY --from=codegolf/lang-bash         ["/", "/langs/bash/rootfs/"        ] # 2.19 MiB
