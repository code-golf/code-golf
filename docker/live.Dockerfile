...
COPY --from=codegolf/lang-powershell ["/", "/langs/powershell/rootfs/"] #  175 MiB
COPY --from=codegolf/lang-c-sharp    ["/", "/langs/c-sharp/rootfs/"   ] #  127 MiB
COPY --from=codegolf/lang-f-sharp    ["/", "/langs/f-sharp/rootfs/"   ] #  112 MiB
