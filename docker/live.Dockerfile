...
COPY --from=codegolf/lang-scala        ["/", "/langs/scala/rootfs/"       ] # 98.3 MiB
COPY --from=codegolf/lang-d            ["/", "/langs/d/rootfs/"           ] # 95.9 MiB
COPY --from=codegolf/lang-vyxal        ["/", "/langs/vyxal/rootfs/"       ] # 92.4 MiB
COPY --from=codegolf/lang-groovy       ["/", "/langs/groovy/rootfs/"      ] # 86.1 MiB
...
COPY --from=codegolf/lang-cjam         ["/", "/langs/cjam/rootfs/"        ] # 71.9 MiB
