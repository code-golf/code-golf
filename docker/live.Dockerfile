...
COPY --from=codegolf/lang-rust       ["/", "/langs/rust/rootfs/"      ] #  531 MiB
...
COPY --from=codegolf/lang-raku       ["/", "/langs/raku/rootfs/"      ] #   57 MiB
COPY --from=codegolf/lang-java       ["/", "/langs/java/rootfs/"      ] # 51.1 MiB
COPY --from=codegolf/lang-v          ["/", "/langs/v/rootfs/"         ] # 37.9 MiB
...
COPY --from=codegolf/lang-nim        ["/", "/langs/nim/rootfs/"       ] # 13.4 MiB
