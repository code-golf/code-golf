...
COPY --from=codegolf/lang-coconut      ["/", "/langs/coconut/rootfs/"     ] #  120 MiB
...
COPY --from=codegolf/lang-hy           ["/", "/langs/hy/rootfs/"          ] # 75.7 MiB
...
COPY --from=codegolf/lang-python       ["/", "/langs/python/rootfs/"      ] # 65.0 MiB
...
COPY --from=codegolf/lang-rockstar-2   ["/", "/langs/rockstar-2/rootfs/"  ] # 6.11 MiB
...
COPY --from=codegolf/lang-hush         ["/", "/langs/hush/rootfs/"        ] # 3.19 MiB
...
COPY --from=codegolf/lang-fennel       ["/", "/langs/fennel/rootfs/"      ] #  639 KiB
