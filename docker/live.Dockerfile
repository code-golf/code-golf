...
COPY --from=codegolf/lang-rust         ["/", "/langs/rust/rootfs/"        ] #  334 MiB
...
COPY --from=codegolf/lang-gleam        ["/", "/langs/gleam/rootfs/"       ] # 91.7 MiB
COPY --from=codegolf/lang-ocaml        ["/", "/langs/ocaml/rootfs/"       ] # 91.5 MiB
...
COPY --from=codegolf/lang-v            ["/", "/langs/v/rootfs/"           ] # 50.1 MiB
...
COPY --from=codegolf/lang-uiua         ["/", "/langs/uiua/rootfs/"        ] # 29.9 MiB
COPY --from=codegolf/lang-05ab1e       ["/", "/langs/05ab1e/rootfs/"      ] # 29.7 MiB
...
COPY --from=codegolf/lang-scheme       ["/", "/langs/scheme/rootfs/"      ] # 7.39 MiB
...
COPY --from=codegolf/lang-befunge      ["/", "/langs/befunge/rootfs/"     ] # 4.68 MiB
COPY --from=codegolf/lang-algol-68     ["/", "/langs/algol-68/rootfs/"    ] # 4.66 MiB
COPY --from=codegolf/lang-cobol        ["/", "/langs/cobol/rootfs/"       ] # 4.61 MiB
COPY --from=codegolf/lang-rockstar-2   ["/", "/langs/rockstar-2/rootfs/"  ] # 4.24 MiB
