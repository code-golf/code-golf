...
COPY --from=codegolf/lang-kotlin       ["/", "/langs/kotlin/rootfs/"      ] #  127 MiB
...
COPY --from=codegolf/lang-iogii        ["/", "/langs/iogii/rootfs/"       ] # 33.3 MiB
...
COPY --from=codegolf/lang-perl         ["/", "/langs/perl/rootfs/"        ] # 5.67 MiB
...
COPY --from=codegolf/lang-bash         ["/", "/langs/bash/rootfs/"        ] # 1.28 MiB
