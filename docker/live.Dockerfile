...
COPY --from=codegolf/lang-gleam        ["/", "/langs/gleam/rootfs/"       ] # 75.3 MiB
COPY --from=codegolf/lang-clojure      ["/", "/langs/clojure/rootfs/"     ] # 67.6 MiB
COPY --from=codegolf/lang-java         ["/", "/langs/java/rootfs/"        ] # 59.3 MiB
COPY --from=codegolf/lang-elixir       ["/", "/langs/elixir/rootfs/"      ] # 57.7 MiB
COPY --from=codegolf/lang-v            ["/", "/langs/v/rootfs/"           ] # 51.4 MiB
COPY --from=codegolf/lang-erlang       ["/", "/langs/erlang/rootfs/"      ] # 50.8 MiB
