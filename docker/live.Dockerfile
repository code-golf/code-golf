...
COPY --from=codegolf/lang-rust         ["/", "/langs/rust/rootfs/"        ] #  379 MiB
...
COPY --from=codegolf/lang-gleam        ["/", "/langs/gleam/rootfs/"       ] # 91.8 MiB
...
COPY --from=codegolf/lang-erlang       ["/", "/langs/erlang/rootfs/"      ] # 68.6 MiB
COPY --from=codegolf/lang-clojure      ["/", "/langs/clojure/rootfs/"     ] # 66.0 MiB
...
COPY --from=codegolf/lang-webassembly  ["/", "/langs/webassembly/rootfs/" ] # 42.8 MiB
...
COPY --from=codegolf/lang-hush         ["/", "/langs/hush/rootfs/"        ] # 3.37 MiB
