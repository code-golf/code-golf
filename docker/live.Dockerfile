...
COPY --from=codegolf/lang-dart       ["/", "/langs/dart/rootfs/"      ] #  231 MiB
...
COPY --from=codegolf/lang-clojure    ["/", "/langs/clojure/rootfs/"   ] #   66 MiB
...
COPY --from=codegolf/lang-javascript ["/", "/langs/javascript/rootfs/"] # 39.9 MiB
...
COPY --from=codegolf/lang-coconut    ["/", "/langs/coconut/rootfs/"   ] # 0.0 MiB
