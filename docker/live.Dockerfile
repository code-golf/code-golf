...
COPY --from=codegolf/lang-factor       ["/", "/langs/factor/rootfs/"      ] #  174 MiB
COPY --from=codegolf/lang-kotlin       ["/", "/langs/kotlin/rootfs/"      ] #  142 MiB
...
COPY --from=codegolf/lang-cpp          ["/", "/langs/cpp/rootfs/"         ] #  112 MiB
...
COPY --from=codegolf/lang-d            ["/", "/langs/d/rootfs/"           ] # 95.9 MiB
COPY --from=codegolf/lang-scala        ["/", "/langs/scala/rootfs/"       ] # 90.1 MiB
COPY --from=codegolf/lang-vyxal        ["/", "/langs/vyxal/rootfs/"       ] # 84.2 MiB
COPY --from=codegolf/lang-coconut      ["/", "/langs/coconut/rootfs/"     ] # 83.8 MiB
COPY --from=codegolf/lang-gleam        ["/", "/langs/gleam/rootfs/"       ] # 83.8 MiB
...
COPY --from=codegolf/lang-groovy       ["/", "/langs/groovy/rootfs/"      ] # 77.9 MiB
...
COPY --from=codegolf/lang-05ab1e       ["/", "/langs/05ab1e/rootfs/"      ] # 69.0 MiB
COPY --from=codegolf/lang-elixir       ["/", "/langs/elixir/rootfs/"      ] # 66.9 MiB
...
COPY --from=codegolf/lang-erlang       ["/", "/langs/erlang/rootfs/"      ] # 58.3 MiB
COPY --from=codegolf/lang-prolog       ["/", "/langs/prolog/rootfs/"      ] # 49.3 MiB
COPY --from=codegolf/lang-javascript   ["/", "/langs/javascript/rootfs/"  ] # 45.5 MiB
COPY --from=codegolf/lang-haxe         ["/", "/langs/haxe/rootfs/"        ] # 41.2 MiB
COPY --from=codegolf/lang-hy           ["/", "/langs/hy/rootfs/"          ] # 41.0 MiB
COPY --from=codegolf/lang-iogii        ["/", "/langs/iogii/rootfs/"       ] # 33.5 MiB
COPY --from=codegolf/lang-v            ["/", "/langs/v/rootfs/"           ] # 33.5 MiB
COPY --from=codegolf/lang-golfscript   ["/", "/langs/golfscript/rootfs/"  ] # 33.4 MiB
COPY --from=codegolf/lang-ruby         ["/", "/langs/ruby/rootfs/"        ] # 33.4 MiB
COPY --from=codegolf/lang-common-lisp  ["/", "/langs/common-lisp/rootfs/" ] # 31.0 MiB
COPY --from=codegolf/lang-r            ["/", "/langs/r/rootfs/"           ] # 30.5 MiB
COPY --from=codegolf/lang-racket       ["/", "/langs/racket/rootfs/"      ] # 29.5 MiB
...
COPY --from=codegolf/lang-j            ["/", "/langs/j/rootfs/"           ] # 22.0 MiB
COPY --from=codegolf/lang-uiua         ["/", "/langs/uiua/rootfs/"        ] # 19.2 MiB
COPY --from=codegolf/lang-qore         ["/", "/langs/qore/rootfs/"        ] # 17.4 MiB
COPY --from=codegolf/lang-nim          ["/", "/langs/nim/rootfs/"         ] # 14.9 MiB
COPY --from=codegolf/lang-apl          ["/", "/langs/apl/rootfs/"         ] # 14.4 MiB
COPY --from=codegolf/lang-harbour      ["/", "/langs/harbour/rootfs/"     ] # 12.2 MiB
COPY --from=codegolf/lang-picat        ["/", "/langs/picat/rootfs/"       ] # 11.7 MiB
...
COPY --from=codegolf/lang-tex          ["/", "/langs/tex/rootfs/"         ] # 7.99 MiB
...
COPY --from=codegolf/lang-algol-68     ["/", "/langs/algol-68/rootfs/"    ] # 5.33 MiB
COPY --from=codegolf/lang-arturo       ["/", "/langs/arturo/rootfs/"      ] # 5.20 MiB
COPY --from=codegolf/lang-luau         ["/", "/langs/luau/rootfs/"        ] # 5.10 MiB
...
COPY --from=codegolf/lang-rexx         ["/", "/langs/rexx/rootfs/"        ] # 3.07 MiB
...
COPY --from=codegolf/lang-knight       ["/", "/langs/knight/rootfs/"      ] #  734 KiB
