...
var unescapeString = (string3) => {
  if (string3.length < 2 || string3[string3.length - 1] != string3[0])
    throw new ParserError("Incomplete string");
  string3 = string3.slice(1, -1).replace(/\\(x[0-9a-f]{1,2}|[0-7]{1,3}|u[0-9a-f]{1,8}|.|$)/ig, (x) => {
    x = x.slice(1);
    if (x == "")
      throw new ParserError("Incomplete string");
